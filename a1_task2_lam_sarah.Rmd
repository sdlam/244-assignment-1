...
Bases on the results of the 10-fold cross validation, we see that model 2 does a slightly better job of predicting oxygen saturation (lower error) than model 1, this aligns with out AIC results as well.
